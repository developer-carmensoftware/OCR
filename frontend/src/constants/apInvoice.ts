...
export const AP_I18N: APTranslations = {
  ...
  docInconsistentHint: "Document figures don't add up — a digit was likely misread.",
  fixDocFigures: 'Fix document figures',
  docFixedToast: 'Corrected from document:',
  docAutoFixedToast: 'Auto-corrected a misread figure:',
  taxAmt: 'Tax Amount',
