...
export const AP_I18N: Record<APLocale, APTranslations> = {
  th: {
    ...
    taxProfileMismatch: 'โปรไฟล์ภาษีไม่ตรงกับค่าเริ่มต้นของคู่ค้า: ',
    docInconsistent: 'ยอดรวมย่อย + ภาษี ≠ ยอดรวมทั้งสิ้น — โปรดตรวจสอบตัวเลขจากเอกสาร',
    ...
    warnMissingHeader: 'เลขที่ใบแจ้งหนี้หรือวันที่ยังไม่ครบ — กรุณากรอกข้อมูลก่อนดำเนินการต่อ',
    warnMissingMapping: 'กรุณาจับคู่คอลัมน์รายการและจำนวนเงินก่อนดำเนินการต่อ',
    warnTaxMismatch: 'รายการมีโปรไฟล์ภาษีไม่ตรงกับค่าเริ่มต้นของคู่ค้า',
    warnTaxUnmatched: 'รายการมีอัตราภาษีที่ไม่ตรงกับโปรไฟล์ใด',
    warnEmptyDesc: 'รายการยังไม่มีคำอธิบาย — Carmen จะปฏิเสธรายการเหล่านี้',
    warnSelectMore: 'เลือกอย่างน้อย 2 รายการเพื่อรวมกลุ่ม',
  },
  en: {
    appTitle: 'Carmen Cloud',
    appSub: 'AP Invoice OCR',
    ...
    taxType: 'Tax Type',
    taxRateUnmatched: 'This rate has no matching Tax Profile — the document rate is kept as-is.',
    taxProfileMismatch: 'Tax profile does not match vendor default: ',
    ...
    invDescLabel: 'Invoice Description',
    invDescPlaceholder: 'Invoice description...',
    warnMissingHeader: 'Invoice Number or Date is missing — fill in before proceeding.',
    warnMissingMapping: 'Please map the Description and Amount columns before continuing.',
    warnTaxMismatch: "line(s) have a tax profile that doesn't match the vendor default.",
    warnTaxUnmatched: 'line(s) have a tax rate not in any profile.',
    warnEmptyDesc: 'line(s) are missing a description — Carmen will reject them.',
    warnSelectMore: 'Select at least 2 items to group.',
  },
}
