      ...
      <tr>
        {activeCols.map((c, i) => {
          ...
          if (fld === 'taxPct') {
            return (
              <Fragment key={c}>
                {!showFixedTaxType && showFixedTaxProfile && <td>{null}</td>}
                <td>{null}</td>
              </Fragment>
            )
          }
          if (fld === 'taxType')
            return (
              <Fragment key={c}>
                {showFixedTaxProfile && showFixedTaxPct && <td>{null}</td>}
                <td>{null}</td>
              </Fragment>
            )
          return <td key={`e${c}`}>{null}</td>
        })}
        {showFixedTaxType && showFixedTaxProfile && <td>{null}</td>}
        {showFixedTaxPct && <td>{null}</td>}
        {showFixedTaxType && <td>{null}</td>}
        <td>{null}</td>
      </tr>
    </tfoot>
  )
