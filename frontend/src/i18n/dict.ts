...
const en = {
  ...
  'flows.cc.n1.cap': 'Fee invoice from a bank or payment gateway',
  ...
  'flows.cc.sup.h': 'Document layouts supported today',
  'flows.cc.sup.bank': 'Banks',
  'flows.cc.sup.gateway': 'Payment gateways',
  ...
  'orev.list.truncated': 'Showing {n} of {total} — narrow the filter to see the rest',
  ...
  'review.close': 'Close',
  'review.sumGross': 'Gross',
  'review.sumCommission': 'Commission',
  'review.sumTax': 'VAT',
  'review.sumNet': 'Net',
  'review.fDocNo': 'Document no.',
  'review.fDocDate': 'Document date',
  'review.fBranch': 'Branch',
  'review.fCompany': 'Billed to',
  'review.fMerchantId': 'Merchant ID',
  'review.fMerchant': 'Merchant',
  ...
  'review.fDocName': 'Document type',
  'review.fBankName': 'Bank',
  'review.fBankCompany': 'Issued by',
  ...
  'review.jvBlankAccount': 'A line with an amount has no account',
  ...
  'review.approveWithRules': 'Approve JV · updates {count}',
  ...
  'review.secDocument': 'Document',
  'review.secDocumentMissing': 'Document number is missing',
  'review.secLines': 'Lines',
  'review.secLinesOk': '{count} lines · {total}',
  'review.secLinesBad': 'Line {lines} does not add up',
  'review.secGl': 'GL mapping',
  'review.secGlOk': '{count} accounts · balanced',
  'review.secGlGuessed': 'AI filled: {fields}',
  'review.secGlBlocked': 'Cannot post — the JV does not balance',
  'review.secTax': 'Input tax',
  'review.secTaxOn': 'Will be recorded',
  'review.secTaxOff': 'Will not be recorded',
  'review.secTaxLabel': 'Post the input tax record',
  'review.secTaxHint': 'Uncheck if you intend to key the VAT record into Carmen by hand.',
  ...
  'admin.nav.item.email': 'Email Automation',
  ...
  'admin.email.action.confirm': 'Check confirmations',
  'admin.email.confirmPoll':
    'Run one mailbox poll now? Documents that match a rule are extracted and charged.',
  'admin.email.kpi.poll': 'Document poll',
  'admin.email.kpi.confirm': 'Confirmation sweep',
  'admin.email.kpi.mailbox': 'Mailbox',
  'admin.email.kpi.today': 'Posted (24h)',
  'admin.email.kpi.every': 'Schedule {schedule}',
  'admin.email.kpi.awaiting': '{n} BU awaiting setup',
  'admin.email.age.now': 'Just now',
  'admin.email.age.min': '{n} min ago',
  'admin.email.age.hour': '{n} h ago',
  'admin.email.age.day': '{n} d ago',
  'admin.email.kpi.notScheduled': 'Not scheduled',
  'admin.email.kpi.noMailbox': 'Not configured',
  'admin.email.kpi.failed': '{n} failed',
  'admin.email.tab.documents': 'Documents',
  'admin.email.tab.units': 'Business units',
  'admin.email.statusAria': 'Document status filter',
  'admin.email.reasonAria': 'Reason filter',
  'admin.email.status.all': 'All statuses',
  'admin.email.reason.all': 'All reasons',
  'admin.email.reason.sender_not_allowed': 'Sender not registered',
  'admin.email.reason.no_rule_match': 'No rule matched the filename',
  'admin.email.reason.unreadable_document': 'Could not read the document',
  'admin.email.reason.wrong_pdf_password': 'Wrong PDF password',
  'admin.email.reason.tax_id_mismatch': 'Tax ID belongs to another BU',
  ...
  'admin.email.col.bu': 'Business unit',
  'admin.email.col.attachment': 'Attachment',
  'admin.email.col.status': 'Status',
  'admin.email.col.reason': 'Reason',
  'admin.email.col.docNo': 'Doc no',
  'admin.email.col.jv': 'JV',
  'admin.email.col.charged': 'Charged',
  'admin.email.col.enabled': 'Enabled',
  'admin.email.col.address': 'Forward to',
  'admin.email.col.forwarding': 'Forwarding',
  'admin.email.col.token': 'Carmen token',
  'admin.email.col.rules': 'Active rules',
  'admin.email.col.documents': 'Documents',
  'admin.email.col.lastMail': 'Last mail',
  'admin.email.on': 'On',
  'admin.email.off': 'Off',
  'admin.email.notConfirmed': 'Not confirmed',
  'admin.email.noToken': 'Missing',
  'admin.email.expandRow': 'Row detail',
  'admin.email.expand': 'Show detail',
  'admin.email.collapse': 'Hide detail',
  'admin.email.detail.error': 'Error',
  ...
  'admin.email.units.denied.title': 'Needs the configs:write permission',
  ...
  'admin.email.toast.running': 'Still running. The documents will appear here as they finish.',
  'admin.email.toast.disabled': 'No mailbox configured (IMAP_HOST is empty)',
...
const th: Record<TKey, string> = {
  ...
  'flows.cc.n1.cap': 'ใบแจ้งค่าธรรมเนียมจากธนาคารและผู้ให้บริการรับชำระเงิน',
  ...
  'flows.cc.sup.h': 'รูปแบบเอกสารที่รองรับแล้ว',
  'flows.cc.sup.bank': 'ธนาคาร',
  'flows.cc.sup.gateway': 'ผู้ให้บริการรับชำระเงิน',
  ...
  'orev.list.truncated': 'แสดง {n} จาก {total} รายการ — กรองให้แคบลงเพื่อดูส่วนที่เหลือ',
  ...
  'review.close': 'ปิด',
  'review.sumGross': 'ยอดรวม',
  'review.sumCommission': 'ค่าธรรมเนียม',
  'review.sumTax': 'ภาษี',
  'review.sumNet': 'ยอดสุทธิ',
  'review.fDocNo': 'เลขที่เอกสาร',
  'review.fDocDate': 'วันที่เอกสาร',
  'review.fBranch': 'สาขา',
  'review.fCompany': 'ในนาม',
  'review.fMerchantId': 'รหัสร้านค้า',
  'review.fMerchant': 'ร้านค้า',
  ...
  'review.jvDept': 'แผนก',
  'review.jvAccount': 'บัญชี',
  'review.jvDesc': 'รายละเอียด',
  'review.jvLineOf': '{field} บรรทัด {line}',
  'review.jvDebitFor': 'เดบิตของ {field}',
  'review.jvCreditFor': 'เครดิตของ {field}',
  'review.jvSharedHint': 'รวมมาจาก {count} บรรทัด — แก้ตรงนี้จะกระจายยอดใหม่ไปทุกบรรทัด',
  'review.fDocName': 'ประเภทเอกสาร',
  'review.fBankName': 'ธนาคาร',
  'review.fBankCompany': 'ออกโดย',
  'review.jvDebit': 'เดบิต',
  'review.jvCredit': 'เครดิต',
  'review.jvDeptPlaceholder': 'แผนก',
  'review.jvAccountPlaceholder': 'บัญชี',
  'review.jvDeptFor': 'แผนกของ {field}',
  'review.jvAccountFor': 'บัญชีของ {field}',
  ...
  'review.jvBlankAccount': 'มีบรรทัดที่มียอดแต่ยังไม่มีบัญชี',
  'review.rulesChanged': 'จะเปลี่ยนกฎบัญชี {count} รายการเมื่อกด Approve',
  'review.rulesChangedPlural': 'จะเปลี่ยนกฎบัญชี {count} รายการเมื่อกด Approve',
  'review.approveWithRules': 'Approve JV · อัปเดตกฎ {count}',
  ...
  'review.colSource': 'ที่มา',
  'review.colDocument': 'เอกสาร',
  'review.colReceived': 'เวลารับ',
  'review.colJv': 'เลขที่ JV',
  'review.colStatus': 'สถานะ',
  'review.colMessage': 'รายละเอียด',
  'review.colActions': 'จัดการ',
  ...
  'review.secDocument': 'เอกสาร',
  'review.secDocumentMissing': 'ไม่มีเลขที่เอกสาร',
  'review.secLines': 'รายการ',
  'review.secLinesOk': '{count} รายการ · {total}',
  'review.secLinesBad': 'รายการที่ {lines} ยอดไม่ลงตัว',
  'review.secGl': 'ผังบัญชี',
  'review.secGlOk': '{count} บัญชี · สมดุล',
  'review.secGlGuessed': 'AI เติมให้: {fields}',
  'review.secGlBlocked': 'โพสต์ไม่ได้ — JV ไม่สมดุล',
  'review.secTax': 'ภาษีซื้อ',
  'review.secTaxOn': 'จะบันทึกให้',
  'review.secTaxOff': 'จะไม่บันทึก',
  'review.secTaxLabel': 'บันทึกรายการภาษีซื้อ',
  'review.secTaxHint': 'ยกเลิกการเลือกถ้าคุณจะคีย์ภาษีซื้อเข้า Carmen เอง',
  ...
  'admin.nav.item.email': 'อีเมลอัตโนมัติ',
  ...
  'admin.email.action.confirm': 'ตรวจคำยืนยัน forward',
  'admin.email.confirmPoll': 'ดึงเมลรอบใหม่เลยไหม? ไฟล์ที่ตรง rule จะถูกอ่านและหักเครดิต',
  'admin.email.kpi.poll': 'รอบดึงเอกสาร',
  'admin.email.kpi.confirm': 'รอบตรวจคำยืนยัน',
  'admin.email.kpi.mailbox': 'กล่องเมล',
  'admin.email.kpi.today': 'โพสต์สำเร็จ (24 ชม.)',
  'admin.email.kpi.every': 'ตารางเวลา {schedule}',
  'admin.email.kpi.awaiting': 'มี {n} BU รอยืนยัน',
  'admin.email.age.now': 'เมื่อครู่นี้',
  'admin.email.age.min': '{n} นาทีก่อน',
  'admin.email.age.hour': '{n} ชม.ก่อน',
  'admin.email.age.day': '{n} วันก่อน',
  'admin.email.kpi.notScheduled': 'ยังไม่ได้ตั้งเวลา',
  'admin.email.kpi.noMailbox': 'ยังไม่ได้ตั้งค่า',
  'admin.email.kpi.failed': 'ล้มเหลว {n}',
  'admin.email.tab.documents': 'เอกสาร',
  'admin.email.tab.units': 'รายหน่วยธุรกิจ',
  'admin.email.statusAria': 'ตัวกรองสถานะเอกสาร',
  'admin.email.reasonAria': 'ตัวกรองสาเหตุ',
  'admin.email.status.all': 'ทุกสถานะ',
  'admin.email.reason.all': 'ทุกสาเหตุ',
  'admin.email.reason.sender_not_allowed': 'ผู้ส่งไม่ได้ลงทะเบียนไว้',
  'admin.email.reason.no_rule_match': 'ชื่อไฟล์ไม่ตรง rule ใด',
  'admin.email.reason.unreadable_document': 'อ่านเอกสารไม่ได้',
  'admin.email.reason.wrong_pdf_password': 'รหัสผ่าน PDF ไม่ถูกต้อง',
  'admin.email.reason.tax_id_mismatch': 'เลขผู้เสียภาษีเป็นของ BU อื่น',
  ...
  'admin.email.col.bu': 'หน่วยธุรกิจ',
  'admin.email.col.attachment': 'ไฟล์แนบ',
  'admin.email.col.status': 'สถานะ',
  'admin.email.col.reason': 'สาเหตุ',
  'admin.email.col.docNo': 'เลขที่เอกสาร',
  'admin.email.col.jv': 'JV',
  'admin.email.col.charged': 'หักไป',
  'admin.email.col.enabled': 'เปิดใช้',
  'admin.email.col.address': 'ที่อยู่สำหรับ forward',
  'admin.email.col.forwarding': 'การยืนยัน forward',
  'admin.email.col.token': 'Carmen token',
  'admin.email.col.rules': 'rule ที่ใช้งาน',
  'admin.email.col.documents': 'เอกสารสะสม',
  'admin.email.col.lastMail': 'เมลล่าสุด',
  'admin.email.on': 'เปิด',
  'admin.email.off': 'ปิด',
  'admin.email.notConfirmed': 'ยังไม่ยืนยัน',
  'admin.email.noToken': 'ไม่มี',
  'admin.email.expandRow': 'รายละเอียดแถว',
  'admin.email.expand': 'ดูรายละเอียด',
  'admin.email.collapse': 'ซ่อนรายละเอียด',
  'admin.email.detail.error': 'ข้อผิดพลาด',
  'admin.email.detail.messageId': 'Message ID',
  ...
  'admin.email.units.denied.title': 'ต้องมีสิทธิ์ configs:write',
  'admin.email.units.denied.description':
  ...
  'admin.email.toast.running': 'ยังทำงานอยู่ เอกสารจะทยอยขึ้นที่ตารางนี้เมื่อเสร็จ',
  'admin.email.toast.disabled': 'ยังไม่ได้ตั้งค่ากล่องเมล (IMAP_HOST ว่าง)',
