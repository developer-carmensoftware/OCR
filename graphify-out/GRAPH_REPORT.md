...
## Corpus Check
- 126 files · ~56,296 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 924 nodes · 1471 edges · 136 communities (112 shown, 24 thin omitted)
- Extraction: 81% EXTRACTED · 19% INFERRED · 0% AMBIGUOUS · INFERRED: 279 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fa1b6772`
...
Cohesion: 0.06
Nodes (29): APSuccessStep(), VendorSearch(), exchangeSSOToken(), getUsage(), revokeSession(), clearToken(), createApiClient(), getStoredToken() (+21 more)
...
Cohesion: 0.1
Nodes (21): useAPExtraction(), useAPInvoice(), useAPSubmission(), reconcileRows(), useAPValidation(), useAPVendor(), useAPExtraction(), useAPSubmission() (+13 more)
...
Cohesion: 0.1
Nodes (12): getAccountingConfig(), detectBankFromCompanyName(), detectBankFromExtracted(), AccountingReview(), buildRows(), fmt(), useAccountingConfig(), codeToDisplayName() (+4 more)

### Community 8 - "Community 8"
Cohesion: 0.16
Nodes (9): APReviewStep(), HEADER_FIELDS(), fmt(), isNumFld(), parseNum(), round2(), addDays(), buildInvoicePayload() (+1 more)
...
Cohesion: 0.11
Nodes (17): get_current_session(), FastAPI dependency — resolves the current authenticated session from JWT + DB., Validates the OCR JWT, looks up the session record, and returns a SessionInfo, create_session_jwt(), decode_session_jwt(), decrypt_carmen_token(), encrypt_carmen_token(), extract_user_id_from_token() (+9 more)
...
Cohesion: 0.23
Nodes (7): useFileUpload(), useOcrExtraction(), useOcrSubmission(), useOcrWizard(), useModal(), useOcrWizard(), CreditCardOCR()

### Community 13 - "Community 13"
Cohesion: 0.38
Nodes (15): Base, Base, DeclarativeBase, TaskStatus, APInvoice, AuditLog, CorrectionFeedback, CreditCard (+7 more)

### Community 14 - "Community 14"
Cohesion: 0.16
Nodes (8): OCR API Routes — thin HTTP layer.  Business logic lives in:   app/tools/extra, Save user-confirmed data to DB. Delegates all logic to submit_tool., submit_receipt_stateless(), SubmitDetailItem, SubmitHeader, SubmitPayload, Typed input for the submit_receipt tool (HTTP-layer agnostic)., SubmitInput

### Community 15 - "Community 15"
Cohesion: 0.13
Nodes (14): CodeOption, FieldMapping, get_mapping_history(), Mapping router — thin HTTP layer for GL account/dept mapping.  Business logic, Upsert confirmed mappings into history (INSERT or UPDATE confirmed_count)., Suggest dept/acc codes for Credit card commission, Input Tax, Bank Account via L, Suggest dept/acc codes for dynamic payment types (Visa, MCA, QR, …) via LLM., Return all saved mapping history rows for a given bank. (+6 more)

### Community 16 - "Community 16"
Cohesion: 0.3
Nodes (8): apiFetch(), fetchMappingHistory(), saveMappingHistory(), suggestMapping(), suggestPaymentTypes(), extractFromFile(), markSubmitted(), submitToLocal()
...
Cohesion: 0.32
Nodes (8): saveAccountingConfig(), useMapping(), useBankConfig(), useMapping(), useMappingData(), useMappingSuggestions(), usePaymentTypes(), Mapping()

### Community 19 - "Community 19"
Cohesion: 0.22
Nodes (7): diffCorrections(), logCorrections(), mapFieldName(), loadSavedState(), useToast(), getJvhDate(), makeProps()

### Community 20 - "Community 20"
Cohesion: 0.31
Nodes (6): fetchAccountCodes(), fetchDepartments(), fetchGLPrefixes(), _parseCarmenHttpError(), submitAPInvoiceToCarmen(), submitToCarmen()
...
Cohesion: 0.29
Nodes (6): handleSelect(), parseJvhDate(), formatDateToDDMMYYYY(), normalizeYearToCE(), parseDateToISO(), parseDDMMYYYYToDate()

### Community 23 - "Community 23"
Cohesion: 0.39
Nodes (11): BaseModel, BankType, Config, CorrectionFeedbackRequest, CorrectionFeedbackResponse, CreditCardSchema, ExtractedCreditCardData, ExtractedDetailRow (+3 more)

### Community 24 - "Community 24"
Cohesion: 0.24
Nodes (9): OCRTask, extract_ap_invoice(), _get_mime_type(), Stateless AP Invoice OCR extraction using Vision LLM (OpenRouter)., SuggestGLItem, SuggestGLRequest, Tool: submit_receipt  Persists user-confirmed receipt data to the local databa, Save confirmed receipt data to DB.      Returns:         success=True  → outp (+1 more)
...
Cohesion: 0.27
Nodes (9): _carmen_base(), exchange_sso_token(), ExchangeRequest, ExchangeResponse, Auth Router — Carmen SSO token exchange.  Flow:   1. Frontend sends Carmen to, Build Carmen API base URL from tenant subdomain., Confirms the Carmen token is live by probing a lightweight endpoint.     Raises, Exchange a Carmen SSO token for an OCR session JWT. (+1 more)

### Community 28 - "Community 28"
Cohesion: 0.29
Nodes (7): Enum, DocumentType, AuditAction, log_action(), Audit Log Service — fire-and-forget user activity logging.  Usage in route han, Persist one audit record asynchronously.     Never raises — logging must not in, str
...
Cohesion: 0.38
Nodes (4): submitInputTax(), fmt(), handleAddInputTax(), InputTaxReconciliation()
...
Cohesion: 0.33
Nodes (5): extract_card(), Stateless extraction: read files, call LLM, return JSON data.     Does NOT save, get_correction_hints(), Correction Service — load correction hints for prompt tuning.  Queries correct, Return {field_name: hint_text} for fields where:       corrections(field, 90d)
...
- **Why does `apiFetch()` connect `Community 16` to `Community 1`, `Community 35`, `Community 4`, `Community 39`, `Community 7`, `Community 8`, `Community 42`, `Community 43`, `Community 18`, `Community 19`, `Community 20`, `Community 30`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `async_session()` connect `Community 26` to `Community 32`, `Community 2`, `Community 3`, `Community 37`, `Community 9`, `Community 44`, `Community 25`, `Community 27`, `Community 28`?**
