# Graph Report - OCR  (2026-05-26)

## Corpus Check
- 112 files · ~51,505 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 856 nodes · 1335 edges · 119 communities (98 shown, 21 thin omitted)
- Extraction: 81% EXTRACTED · 19% INFERRED · 0% AMBIGUOUS · INFERRED: 251 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0c78c691`
...
6. `CarmenAPIError` - 16 edges
7. `async_session()` - 15 edges
8. `Base` - 14 edges
9. `_client()` - 14 edges
10. `_base_url()` - 13 edges
...
Cohesion: 0.05
Nodes (70): Base, Base, BaseModel, DeclarativeBase, Enum, BankType, DocumentType, TaskStatus (+62 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (28): AdminLogin(), AdminProtectedRoute(), handleResolve(), load(), handleRevoke(), load(), adminFetch(), adminLogin() (+20 more)
...
Cohesion: 0.07
Nodes (15): diffCorrections(), logCorrections(), mapFieldName(), extractFromFile(), markSubmitted(), useFileUpload(), useOcrExtraction(), useOcrSubmission() (+7 more)
...
Cohesion: 0.12
Nodes (17): exchangeSSOToken(), getUsage(), revokeSession(), clearToken(), getStoredToken(), resolveUrl(), storeToken(), handleOpen() (+9 more)
...
Cohesion: 0.22
Nodes (10): apiFetch(), getAccountingConfig(), getAPVendorMapping(), saveAccountingConfig(), saveAPVendorMapping(), fetchMappingHistory(), saveMappingHistory(), suggestMapping() (+2 more)
...
Cohesion: 0.25
Nodes (10): useAPExtraction(), useAPSubmission(), useAPValidation(), useAPVendor(), getAvailableFields(), useAPInvoice(), fmt(), parseNum() (+2 more)

### Community 14 - "Community 14"
Cohesion: 0.26
Nodes (10): fetchAccountCodes(), fetchDepartments(), fetchGLPrefixes(), _parseCarmenHttpError(), submitAPInvoiceToCarmen(), submitInputTax(), submitToCarmen(), addDays() (+2 more)
...
Cohesion: 0.23
Nodes (6): addDays(), buildInvoicePayload(), handleAddInputTax(), parseJvhDate(), normalizeYearToCE(), parseDateToISO()
...
Cohesion: 0.31
Nodes (6): useMapping(), useBankConfig(), useMappingData(), useMappingSuggestions(), usePaymentTypes(), Mapping()
...
Cohesion: 0.33
Nodes (3): showToast(), mockSuccess(), withExtractedData()
...
- **Why does `apiFetch()` connect `Community 11` to `Community 32`, `Community 4`, `Community 8`, `Community 14`, `Community 16`, `Community 28`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `async_session()` connect `Community 21` to `Community 0`, `Community 2`, `Community 3`, `Community 34`, `Community 9`, `Community 10`, `Community 22`, `Community 24`, `Community 30`?**
